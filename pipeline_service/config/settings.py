...
class Settings(BaseSettings):
    ...
    background_removal_model_id: str = Field(default="briaai/RMBG-2.0", env="BACKGROUND_REMOVAL_MODEL_ID")
    input_image_size: tuple[int, int] = Field(default=(1024, 1024), env="INPUT_IMAGE_SIZE")
    output_image_size: tuple[int, int] = Field(default=(518, 518), env="OUTPUT_IMAGE_SIZE")
    padding_percentage: float = Field(default=0.15, env="PADDING_PERCENTAGE")
